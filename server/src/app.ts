...
import { hostCommandFallbackRoutes } from "./routes/host-command-fallbacks.js";
...
import { socialRoomRoutes } from "./routes/social-room.js";
...
export async function createApp(
  ...
  api.use(hostCommandFallbackRoutes(db));
