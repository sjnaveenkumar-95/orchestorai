...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@orchestorai/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@orchestorai/adapter-utils").TranscriptEntry[];
