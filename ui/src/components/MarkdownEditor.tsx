...
import { buildProjectMentionHref, parseProjectMentionHref } from "@orchestorai/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("orchestorai-project-mention-chip");
      ...
      link.classList.add("orchestorai-project-mention-chip");
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative orchestorai-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("orchestorai-mdxeditor", !bordered && "orchestorai-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "orchestorai-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
