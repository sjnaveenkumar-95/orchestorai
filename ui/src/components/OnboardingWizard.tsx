...
import type { AdapterEnvironmentTestResult } from "@orchestorai/shared";
...
const DEFAULT_TASK_DESCRIPTION = `Setup yourself as the CEO. Use the ceo persona found here: [https://github.com/orchestorai/companies/blob/main/default/ceo/AGENTS.md](https://github.com/orchestorai/companies/blob/main/default/ceo/AGENTS.md)
                    ...
                    <div className="space-y-3">
                      <div>
                        <div className="flex items-center gap-1.5 mb-1">
                          ...
                          <HintIcon text="OrchestorAI works best if you create a new folder for your agents to keep their memories and stay organized. Create a new folder and put the path here." />
                        </div>
