import type { Project } from "@orchestorai/shared";

export const PROJECT_ORDER_UPDATED_EVENT = "orchestorai:project-order-updated";
const PROJECT_ORDER_STORAGE_PREFIX = "orchestorai.projectOrder";
