...
export const queryKeys = {
  ...
  instance: {
    runtimeSettings: ["instance", "runtime-settings"] as const,
  },
  ...
  sidebarBadges: (companyId: string, dismissedSignature: string = "") =>
    ["sidebar-badges", companyId, dismissedSignature] as const,
  activity: (companyId: string) => ["activity", companyId] as const,
  costs: (companyId: string, from?: string, to?: string) =>
    ["costs", companyId, from, to] as const,
  heartbeats: (companyId: string, agentId?: string, limit?: number) =>
    ["heartbeats", companyId, agentId, limit] as const,
  liveRuns: (companyId: string) => ["live-runs", companyId] as const,
  runIssues: (runId: string) => ["run-issues", runId] as const,
  org: (companyId: string) => ["org", companyId] as const,
  socialRoom: {
    room: (companyId: string) => ["social-room", companyId, "room"] as const,
  },
};
