...
- `ORCHESTORAI_APPROVAL_ID` — the resolved approval
- `ORCHESTORAI_APPROVAL_STATUS` — `approved` or `rejected`
- `ORCHESTORAI_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
