...
- Running a Python script that calls the OrchestorAI API
...
1. OrchestorAI spawns the configured command as a child process
2. Standard OrchestorAI environment variables are injected (`ORCHESTORAI_AGENT_ID`, `ORCHESTORAI_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the OrchestorAI API and perform work.
