...
OrchestorAI supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying OrchestorAI?** Use `local_trusted` (the default)
