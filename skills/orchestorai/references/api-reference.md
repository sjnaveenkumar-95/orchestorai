# OrchestorAI API Reference

Detailed reference for the OrchestorAI control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "OrchestorAI Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "orchestorai-mobile",
    "cwd": "/Users/me/orchestorai-mobile",
    "repoUrl": "https://github.com/acme/orchestorai-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `orchestorai-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
