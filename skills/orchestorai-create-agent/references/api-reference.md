# OrchestorAI Create Agent API Reference
...
- After approval resolution, requester may be woken with `ORCHESTORAI_APPROVAL_ID` and should reconcile linked issues.
