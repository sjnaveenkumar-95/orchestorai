...
- `skills/orchestorai/SKILL.md` and `skills/orchestorai/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.1 `skills/orchestorai/SKILL.md`
...
## 6.2 `skills/orchestorai-create-agent/SKILL.md`
