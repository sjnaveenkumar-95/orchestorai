...
- installed adapter list for this OrchestorAI instance
...
## 8. New Skill: `orchestorai-create-agent`

Create new skill directory:

- `skills/orchestorai-create-agent/SKILL.md`
...
Also update `skills/orchestorai/SKILL.md` to reference this skill for hiring workflows.
...
- `orchestorai-create-agent` skill + docs updates
