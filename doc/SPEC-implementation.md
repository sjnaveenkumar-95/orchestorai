# OrchestorAI V1 Implementation Spec
...
OrchestorAI V1 must provide a full control-plane loop for autonomous agents:
...
- Primary: PostgreSQL
- Local default: embedded PostgreSQL at `~/.orchestorai/instances/default/db`
- Optional local prod-like: Docker Postgres
- Optional hosted: Supabase/Postgres-compatible
- File/object storage:
  - local default: `~/.orchestorai/instances/default/data/storage` (`local_disk`)
...
- exactly one JSON entrypoint: `orchestorai.manifest.json`
