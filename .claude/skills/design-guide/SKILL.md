...
name: design-guide
description: >
  OrchestorAI UI design system guide for building consistent, reusable frontend
...
# OrchestorAI Design Guide

OrchestorAI's UI is a professional-grade control plane — dense, keyboard-driven, dark-themed by default. Every pixel earns its place.
...
2. **Custom composites** (`ui/src/components/`) — StatusBadge, EntityRow, MetricCard, etc. These capture OrchestorAI-specific design language.
